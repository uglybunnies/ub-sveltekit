...
<article class="${"project"}"><header><h2>SerpentVenom</h2>
  ...
  <section class="${"tech"}"><h3>Technical Details</h3>
    ...
    <p>The Lightbox was also written in vanilla JavaScript. This script collected all of the anchor tags with a specific class name. Each anchor&#39;s HREF attribute was the location of the larger version of the thumnail image that the anchor contained. The ALT attribute of each thumbnail provided the caption of each image in the Lightbox itself. The navigation of the images in the lightbox was sequential and continuous, going back to the start if you reached the last image while going forward or backward.</p></section></article>`;
});
export {
  Page as default
};
