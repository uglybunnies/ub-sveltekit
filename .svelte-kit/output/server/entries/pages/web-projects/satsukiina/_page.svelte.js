...
<article class="${"project"}"><header><h2>Satsuki Ina Website</h2>
  ...
  <section class="${"tech"}"><h3>Technical Details</h3>
    ...
    <p>JavaScript was used to run the menu including calculating the height of the main menu and the sub-menus for mobile so that the height could be animated via CSS transitions when they were expanded.</p></section></article>`;
});
export {
  Page as default
};
