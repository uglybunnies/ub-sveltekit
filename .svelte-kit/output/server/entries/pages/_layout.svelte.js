...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<header class="${"masthead"}"><div class="${"logo"}"><h1 class="${"site-name"}"><a class="${"slink"}" href="${"/"}"><span>Ugly</span> <span>Bunnies</span></a></h1></div></header>
<nav class="${"topnav"}"><ul class="${"menu"}"><li><a href="${"/"}">Home</a></li>
